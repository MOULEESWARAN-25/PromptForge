/**
 * Cost, Rate, and Context Limits Configuration
 * ─────────────────────────────────────────────────────────────────
 ...
 *
 * ADR Reference: docs/adr/0002-ai-provider-abstraction.md
 */
...
export const LIMITS = {
  ...
  /**
   * Maximum estimated cost per request in USD (used for cost-guard checks).
   * Set via dynamic model pricing maps in the backend.
   */
   ...
   * Records older than this are eligible for automated purge.
   */
